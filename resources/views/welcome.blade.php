...
<body class="antialiased">
    <div
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            @if(Auth::guard('admin')->check() || Auth::guard('clinic')->check() || Auth::guard('pharmacy')->check())
            ...
            <a href="{{ route('facility.login') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Facility
                Login</a>
            <a href="{{ route('doctor.login') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Doctor
                Login</a>
