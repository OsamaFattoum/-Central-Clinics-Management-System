			...
			<div class="card-body">
				...
				<div class="text-wrap">
					...
					<figure class="highlight clip-widget" id="tabs">
						<pre><code class="language-markup"><script type="html-dashlead/script"></script></code></pre>
					...
					<div class="panel-body tabs-menu-body main-content-body-right border">
						<div class="tab-content">
							...
							<div class="tab-pane" id="tab3">
								<p>praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias
									excepturi sint occaecati cupiditate non provident,</p>
								<p class="mb-0">similique sunt in culpa qui officia deserunt mollitia animi, id est
			...
			<div class="card-body">
				...
				<div class="text-wrap">
					...
					<figure class="highlight mb-0" id="element2">
						<pre><code class="language-markup mb-0"><script type="prismsmix/javascript"></script></code></pre>
						<div class="clipboard-icon" data-clipboard-target="#tabs"><i class="las la-clipboard"></i></div>
					</figure>
					<div class="panel panel-primary tabs-style-2">
						<div class=" tab-menu-heading">
						...
						<div class="tab-menu-heading">
							<div class="tabs-menu ">
								...
								<ul class="nav panel-tabs">
									<li class=""><a href="#tab11" class="active" data-toggle="tab"><i
												class="fa fa-laptop"></i> Tab Style 01</a></li>
									<li><a href="#tab12" data-toggle="tab"><i class="fa fa-cube"></i> Tab Style 02</a>
									</li>
									<li><a href="#tab13" data-toggle="tab"><i class="fa fa-cogs"></i> Tab Style 03</a>
									</li>
									<li><a href="#tab14" data-toggle="tab"><i class="fa fa-tasks"></i> Tab Style 04</a>
									</li>
								</ul>
							</div>
								...
								<div class="tab-menu-heading">
									<div class="tabs-menu ">
										...
										<ul class="nav panel-tabs">
											<li class=""><a href="#tab21" class="active" data-toggle="tab"><i
														class="fa fa-laptop"></i> Tab Style 01</a></li>
											<li><a href="#tab22" data-toggle="tab"><i class="fa fa-cube"></i> Tab Style
													02</a></li>
											<li><a href="#tab23" data-toggle="tab"><i class="fa fa-cogs"></i> Tab Style
													03</a></li>
											<li><a href="#tab24" data-toggle="tab"><i class="fa fa-tasks"></i> Tab Style
													04</a></li>
										</ul>
									</div>
								</div>
							...
							<div class="panel-body tabs-menu-body">
								<div class="tab-content">
									...
									<div class="tab-pane" id="tab24">
										<p>On the other hand, we denounce with righteous indignation and dislike men who
											are so beguiled and demoralized by the charms of pleasure of the moment, so
											blinded by desire quod maxime placeat facere possimus, omnis voluptas
											assumenda est, omnis dolor repellendus.</p>
										<p>On the other hand, we denounce with righteous indignation and dislike men who
											are so beguiled and demoralized by the charms of pleasure of the moment, so
											blinded by desire quod maxime placeat facere possimus, omnis voluptas
			...
			<div class="text-wrap">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="default-tab" role="tabpanel" aria-labelledby="html-tab">
						...
						<div class="clipboard-icon" data-clipboard-target="#element5"><i class="las la-clipboard"></i>
						</div>
						</figure>
					</div>
