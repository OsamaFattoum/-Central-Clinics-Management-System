                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input id="name_dep_{{ $local }}" type="text" name="{{ $local }}[name]" value="{{ $department->translate($local)->name }}"
                                class="form-control">
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <label for="scientfic_n">@lang('departments.scientific_name')<span
                                    class="tx-danger">*</span></label>
                            <input id="scientfic_n" type="text" name="scientific_name" value="{{ $department->scientific_name }}" class="form-control">
                        </div>
                        <div class="form-group col">
                    ...
                    <div class="form-group ">
                        ...
                        <textarea style="resize: none" name="{{ $local }}[description]" id="desc_{{ $local }}" rows="5"
                            class="form-control {{ $local == 'en' ? 'text-left' : '' }}">{{ $department->translate($local)->description }}</textarea>
                    </div>
                    @endforeach
                </div>
