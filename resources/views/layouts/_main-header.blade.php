	...
	<div class="container-fluid">
		<div class="main-header-left ">
			<div class="responsive-logo">
				<a href="{{ route('dashboard') }}"><img src="{{URL::asset('assets/img/brand/logo_'. app()->getLocale() .'.png')}}"
                    ...
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                    src="{{URL::asset('assets/img/flags/jordan_flag.jpg')}}" alt="img"></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            ...
                            <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}"
                                ...
                                @endif
                                <span class="mx-2">{{ $properties['native'] }}</span>
                            </a>
                            @endforeach
                        </div>
                    </div>
				...
				<div class="dropdown main-profile-menu nav nav-item nav-link">
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item"
							...
							href="{{ route('logout') }}"><i class="bx bx-log-out"></i>@lang('header.l_logout')</a>
