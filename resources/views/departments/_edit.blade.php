<div class="modal fade" id="edit{{ $department->id }}" tabindex="-1" role="dialog" aria-labelledby="addLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('departments.update',$department->id) }}" method="post" autocomplete="off"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col">
                            ...
                            <input id="name_dep_{{ $local }}" required type="text" name="{{ $local }}[name]"
                                value="{{ $department->translate($local)->name }}" class="form-control">
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col">
                            <label for="scientfic_n">@lang('departments.scientific_name')<span
                                    class="tx-danger">*</span></label>
                            <input id="scientfic_n" required type="text" name="scientific_name"
                                value="{{ $department->scientific_name }}" class="form-control">
                        </div>
                        <div class="form-group col">
                            ...
                            <select id="give_drug" required name="status" class="form-control">
                                <option value="0" {{ $department->status === 0 ? 'selected' : ''
                                    }}>@lang('departments.not_give_drug')</option>
                                <option value="1" {{ $department->status === 1 ? 'selected' : ''
                                    }}>@lang('departments.give_drug')</option>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-10 form-group">
                        ...
                        <div class="icon-show col-lg-4 col-2">
                            <label for="icon"></label>
                            <div class="">
                                <img alt="Responsive image" class="img-thumbnail wd-60"
                                src="{{URL::asset($department->image_path)}}">
                            </div>
                        </div>
                    </div>
