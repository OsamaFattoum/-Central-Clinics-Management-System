                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pr-2"><a class="btn btn-outline-success btn-sm"
                                        href="{{ route('clinics.index',['department'=>$department->id]) }}">@lang('departments.related_clinic')</a>
                                </td>
                                <td class="pr-2"><a class="btn btn-outline-info btn-sm"
                                        href="{{ route('case_types.index',['department'=>$department->id]) }}">@lang('departments.related_case_type')</a>
                                </td>
                                <td class="pr-2">
                                    <div class="dropdown">
                                ...
                                $department->name,'route'=>'departments','parameters'=> ['department' =>
                                $department->id]])
